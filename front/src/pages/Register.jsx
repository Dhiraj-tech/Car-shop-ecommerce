                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 text-center">
                            <div className="card-body p-4">
                                <div className="mt-5">
                                    <img src="signup.jpg" alt="" className="img-fluid" />
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="title">Signup</div>
                                    <Form onSubmit={handleSubmit} className="auth-form">
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <Form.Control className="form-control" id="address" name="address"  
                                            placeholder="Enter your address" onChange={e => setInState
                                            (e, form, setForm)} required />
                                        </div>
